...
import IllnessViewComponent from "../../../components/pageSpecific/illnesses/view/View";
import { useParams } from "react-router-dom";

function IllnessView() {
  const params = useParams();
  const store = useSelector(selectIllness);
  const dispatch = useDispatch();
  const pageName = "View illness";
  const breadCrumbs = [
    {
      name: "Dashboard",
      link: "/dashboard",
              ...
              <div className="col-md-12">
                <div className="card">
                  ...
                  <div className="card-body">
                    <IllnessViewComponent formData={store.formData} />
                  </div>
